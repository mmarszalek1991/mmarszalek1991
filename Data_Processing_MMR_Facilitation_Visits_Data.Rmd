...
dataMMR_V2$apl_tool <- if_else(dataMMR_V2$year >= 2023, 0 , dataMMR_V2$apl_tool)
...
time_variables_post <- data.frame(time_3 = seq(1,13))

table_02 <- data.frame(time_3 = rep(0,48))

time_variables_post <- rbind(table_02, time_variables_post)

dataMMR_V2 <- cbind(dataMMR_V2, time_variables_post)
...
dataMMR_fac$apl_tool <- if_else(dataMMR_fac$year >= 2023, 0 , dataMMR_fac$apl_tool)
...
dataMMR_fac <- cbind(dataMMR_fac, time_variables_post)
